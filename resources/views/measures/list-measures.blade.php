                        ...
                        <div class="shadow overflow-hidden border border-gray-200 sm:rounded-lg m-6">
                            ...
                            <table class="w-full divide-y divide-gray-200">
                                ...
                                @foreach($measures as $measure)
                                    ...
                                    <tr>
                                        <td class="px-3 py-3">{{$measure->measure}}</td>
                                        ...
                                        <td>
                                            <div class="flex justify-start space-x-1">
                                                ...
                                                <a href="{{url('/measures/'.$measure->id_measure .'/edit')}}" class="border-2 border-indigo-200 rounded-md p-1">
                                                ...
                                                <form action="{{route('delete-measure',$measure->id_measure)}}" method="post" >
                                                    @csrf
